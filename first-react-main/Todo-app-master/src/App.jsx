...
//     {"id":18,"todo":"Draw and color a Mandala","completed":true,"userId":18},
...
//   return (
//     <div style={darkStyles.app}>
//       <Router>
//         <Navbar />
//         <div style={darkStyles.content}>
//           <Routes>
      ...
      <Router>
        ...
        <div style={darkStyles.content}>
          <Routes>
            ...
            {/* Todo list route */}
            <Route path="/todos" element={<HomePage todos={todos} setTodos={setTodos} />} />
